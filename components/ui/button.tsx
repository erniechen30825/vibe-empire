...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "bg-brand text-white shadow-xs hover:bg-brand/90 focus-visible:ring-brand",
        destructive:
          "bg-red-500 text-white shadow-xs hover:bg-red-600 focus-visible:ring-red-500",
        outline:
          "border border-ink text-ink bg-transparent shadow-xs hover:bg-sand/50 focus-visible:ring-sand",
        secondary:
          "bg-mint text-ink shadow-xs hover:bg-mint/80 focus-visible:ring-mint",
        ghost:
          "text-ink hover:bg-sand/30 focus-visible:ring-sand",
